    ...
    <table class="table">
        ...
        <tbody>
            ...
            ?>
                ...
                ?>
                    <tr>
                        <td><?php echo htmlspecialchars($ranking->id); ?></td>
                    
                        <td><?php echo htmlspecialchars($ranking->nombre); ?></td>
                        <td><?php echo htmlspecialchars($ranking->intentos); ?></td>
            ...
            ?>
                <tr>
                    <td colspan="4" style="text-align: center;">No hay Nombres registradas.</td>
                </tr>
            <?php
            // Fin del bloque if
            endif;
